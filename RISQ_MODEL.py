...
def RISQ_Calc(theta_b,theta_t,theta_ap,eta_sqrd,tau_sqrd,tau_ap):
    ...
    for i in range(0, N):
        S_BS1 = generate_S_DB(np.pi/3, np.pi/3, eta_sqrd, tau_sqrd)
...
def plotRISQCurve(theta_ap, P_a_c, P_a_l, P_a_c_Single, dashedLine):
    plt.figure(1)
...
plotRISQCurve(theta_ap, P_a_c, P_a_l, P_a_c_Single, dashedLine)
